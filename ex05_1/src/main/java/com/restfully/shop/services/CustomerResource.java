...
public class CustomerResource {
    ...
    private final Map<Integer, Customer> customerDB = Collections.synchronizedMap(new LinkedHashMap<>());
    ...
    private void outputCustomer(String indent, PrintStream writer, Customer cust) {
