...
public class InjectionTest {
    ...
    @Test
    public void testCarResource() {
        System.out.println("**** CarResource Via @MatrixParam ***");
        String car = client
                .target("http://localhost:8080/services/cars/matrix/mercedes/e55;color=black/2006")
                .request().get(String.class);
        System.out.println(car);

        System.out.println("**** CarResource Via PathSegment ***");
        car = client
                .target("http://localhost:8080/services/cars/segment/mercedes/e55;color=black/2006")
                .request().get(String.class);
        System.out.println(car);

        System.out.println("**** CarResource Via PathSegments ***");
        car = client
                .target("http://localhost:8080/services/cars/segments/mercedes/e55/amg/year/2006")
                .request().get(String.class);
        System.out.println(car);

        System.out.println("**** CarResource Via PathSegment ***");
        car = client
                .target("http://localhost:8080/services/cars/uriinfo/mercedes/e55;color=black/2006")
                .request().get(String.class);
        System.out.println(car);
    }
    ...
    public void testCustomerResource() {
        ...
        list = client
                .target("http://localhost:8080/services/customers/uriinfo")
                .queryParam("start", "2")
                .queryParam("size", "2")
                .request().get(String.class);
        System.out.println(list);
